...
| Documentação (API, arquitetura, 24 decisões, operações, identidade) | ✅ |
...
└── docs/
    ...
    ├── DECISIONS.md                Porque cada decisão foi tomada (24 decisões)
...
- **[docs/DECISIONS.md](docs/DECISIONS.md)** — 24 decisões de arquitetura com alternativas
